...
(custom-set-variables
 ...
 '(package-selected-packages
   '(caml ocamlformat scala-mode fsharp-mode doom-themes rescript-mode yasnippet which-key web-mode use-package tron-legacy-theme tide racket-mode neotree moe-theme lsp-ui kotlin-mode haskell-mode gruvbox-theme flycheck-credo erlang deadgrep color-theme-sanityinc-tomorrow clojure-mode alchemist))
